...
class MainPage extends Component {
  ...
  componentDidMount(){
    this.props.addPost({
      title: "CAT",
      url: "http://www.cats.org.uk/uploads/branches/1/environment-faqs.jpg",
      ...
      <center >
        ...
        <div className="row">
            ...
            <center className="col-sm-8 col-md-offset-2">
              <Link to={'/posts/new'}><button className="btn btn-success btn-md btn-block" type="button">Add New Content</button></Link>
